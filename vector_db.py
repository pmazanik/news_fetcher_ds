...
class LangChainVectorDB:
    ...
    def _get_embeddings(self):
        """Get OpenAI embeddings using LangChain"""
        try:
...
"""
    ...
    def create_qa_chain(self):
        ...
        try:
            ...
            # Create custom prompt for news Q&A
            prompt_template = """Use the following pieces of context to answer the question about news articles.
            If you don't know the answer, just say that you don't know. Be concise and factual.

            Context: {context}

            Question: {question}

            Answer based on the news articles:"""
